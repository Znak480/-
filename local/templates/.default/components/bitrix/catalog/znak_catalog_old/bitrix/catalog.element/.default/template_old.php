          ...
          <div class="product-chars-new">
            ...
            <div class="product-info__price-card">
                ...
                <? if (!empty($arResult['PROPERTIES']['AKTSIYA_']['VALUE'])) { ?>
                    ...
                    <span class="p-price p-price_strong"><?= number_format($arResult['PRICES']['BASE']['VALUE'] - $arResult['PROPERTIES']['AKTSIYA_']['VALUE'] / 100 * $arResult['PRICES']['BASE']['VALUE'], 2, ',', ' ') ?> р.</span>**
                <? } else { ?>
                    <span class="blue">Цена по карте</span>
                    <span class="p-price p-price_strong"><?= number_format($arResult['PRICES']['BASE']['VALUE'] - $arResult['PROPERTIES']['SKIDKA_PO_KARTE_']['VALUE'] / 100 * $arResult['PRICES']['BASE']['VALUE'], 2, ',', ' ') ?> р.</span><span style="position: absolute;">**</span>
                <? } ?>
            </div>
