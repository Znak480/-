...
//echo "<pre style='display: none'>ViewedElems:";
        ...
        <div class="p-list p-list_borders">
            <?$i=0; foreach ($arResult['ITEMS'] as $arItem) { ?>
                <div class="p-item product">
                    <a href="<?=$arItem['DETAIL_PAGE_URL']?>" class="p-item__link">
                        <div class="p-item__image image">
                            <?$file = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]['ID'], array('width'=>130, 'height'=>110), BX_RESIZE_IMAGE_PROPORTIONAL, true);
                            //var_dump($arItem['PREVIEW_PICTURE']);
                            ?>
                            <img src="<?=$file['src']?>" alt="">
                        </div>
                        <span class="p-item__name"><?=$arItem['NAME']?></span>
                    </a>
                    <div class="p-item__bot">
                        <span class="p-item__price"><?=$arItem['ITEM_PRICES'][0]['PRICE']?> р.</span>
                        <button class="p-item__buy add-to-cart" rel="<?=$arItem['ID']?>" ></button>
                    </div>
                </div>
            <?
