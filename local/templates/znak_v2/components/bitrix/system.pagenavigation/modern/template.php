...
<div class="catalog-pagination-wrapper" id="<?= $containerId ?>" <?= $isAjax ? 'data-ajax="Y"' : '' ?>>
	
	<? if ( $arResult["NavRecordCount"] !== $arResult["NavLastRecordShow"] ): ?>
		<!-- Кнопка "Показать еще" -->
		<button class="btn btn-outline btn-sm btn-load-more" 
				data-page="2" 
				data-total="<?= $arResult["NavPageCount"] ?>"
			...
			Показать еще
			<span class="load-more-count">(<?= $arResult["NavRecordCount"] - $arResult["NavLastRecordShow"] ?>)</span>
		</button>
