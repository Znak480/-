...
$showTitle = $arParams['SHOW_TITLE'] ?? 'Y';
?>
...
<a 
	...
	id="btn-cart" class="btn btn-ghost btn-action <?= $totalCount > 0 ? "active" : "" ?>" 
	aria-label="Корзина"
>
	...
	<span data-badge="basket" class="badge <?= $totalCount > 0 ? "" : "hidden" ?>"><?= $totalCount ?></span>
</a>