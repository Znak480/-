...
<a href="<?= $arParams['PAGE_LINK'] ?>" class="js-intensa-favorite-counter btn btn-ghost btn-action <?= $arResult['COUNT'] > 0 ? 'active' : "" ?>" aria-label="Избранное">
    ...
    <span data-entity="favorite-counter" class="badge <?= $arResult['COUNT'] > 0 ? '' : "hidden" ?>"><?= $arResult['COUNT'] ?></span>
</a>