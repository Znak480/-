...
?>
	...
	<div class="footer">
		<div class="wrapper">
			...
			<div class="contact-form-modal orderCall"><a class="close">X</a>
				<div class="form-table" id="feedbackwrap">
					...
					<div class="line extended-line">
						...
						<div class="input"><input type="text" value="" name="fix" size="3"></div>
						<div class="clear"></div>
					</div>
            ...
            <div class="contact-form-modal buy-one-click"><a class="close">X</a>
                <div class="form-table" id="feedbackwrap">
            ...
            <div class="contact-form-modal isNovosib" style="display: <?echo ($_SESSION['city']=='novosibirsk' ? 'block' : 'none')?>;">
                ...
                <div class="form-table" id="feedbackwrap">
                    ...
                    <div class="line">
                        <p>
                            Для Новосибирска у нас есть отдельный сайт: <a href="http://nsk.znakooo.ru"> http://nsk.znakooo.ru </a>
                        </p>
                        <div class="clear"></div>
                    </div>
                    <div class="line">
	...
	false
			...
			<div class="social">
            <ul class="">
                <li><a href="https://vk.com/znakooo" target="_blank"><img src="/images/vk-icon.png"/></a></li>
                <li><a href="https://ok.ru/znakooo" target="_blank"><img src="/images/ok-icon.png"/></a></li>
            </ul>
<!--            <script type="text/javascript" src="//yastatic.net/share/share.js" charset="utf-8"></script><div class="yashare-auto-init" data-yashareL10n="ru" data-yashareType="none" data-yashareQuickServices="vkontakte,odnoklassniki,moimir"></div>-->
	...
	<div class="post-footer">
		<div class="wrapper">
			<p>При полном или частичном использовании материалов с сайта, ссылка на источник обязательна. Вся представленная на сайте информация, касающаяся технических характеристик, наличия на складе, стоимости товаров и услуг, носит информационный характер и ни при каких условиях не является публичной офертой.</p>
		</div>
	</div>
