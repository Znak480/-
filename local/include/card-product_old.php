        ...
        <div class="p-product__prices">
            <div class="p-product__price">
                <? if (!empty($arItem['PROPERTIES']['AKTSIYA_']['VALUE'])) { ?>
                    ...
                    <strong><?= number_format($arItem['PRICES']['BASE']['VALUE'] - $arItem['PROPERTIES']['AKTSIYA_']['VALUE'] / 100 * $arItem['PRICES']['BASE']['VALUE'], 2, ',', ' ') ?> р.</strong>
                <? } else { ?>
                    <span>Цена по карте</span>
                    <strong><?= number_format($arItem['PRICES']['BASE']['VALUE'] - $arItem['PROPERTIES']['SKIDKA_PO_KARTE_']['VALUE'] / 100 * $arItem['PRICES']['BASE']['VALUE'], 2, ',', ' ') ?>
                        р.</strong>
                <? } ?>
            </div>
            <? //базовая цена?>
